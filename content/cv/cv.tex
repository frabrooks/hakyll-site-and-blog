...
\begin{tabular*}{7in}{@{\extracolsep{\fill}}rcccl@{\extracolsep{\fill}}}
  ...
  \;\;\;\;\;\;\; & Automated Testing & SQL / Relational Databases &  \LaTeX\;(LaTeX) &  \;\;\;\;\;\;\; \\
...
{\small 
  ...
  \item Years of experience with Java \& Object Oriented Programming through writting a messaging system, a multiplayer game that was hosted on an AWS EC2 instnace, as well as several android apps.
